...
export default function ShareFeedbackScreen() {
  ...
  const handleSubmit = () => {
    if (!feedbackType || !feedback.trim()) {
      Alert.alert('Error', 'Please select a feedback type and provide your feedback');
      return;
    }
    setSubmitting(true);
    // Simulate API call
      ...
      >
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
          <Text style={styles.intro}>
            We'd love to hear your thoughts! Your feedback helps us improve Gobia.
          </Text>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.chipContainer}>
                {feedbackTypes.map((type) => (
                  <TouchableOpacity
                    key={type}
                    style={[styles.chip, feedbackType === type && styles.chipActive]}
                    onPress={() => setFeedbackType(type)}
                  >
                    <Text style={[styles.chipText, feedbackType === type && styles.chipTextActive]}>
                      {type}
                    </Text>
                  </TouchableOpacity>
                ))}
          ...
          <Button
            ...
            disabled={submitting || !feedbackType || !feedback.trim()}
